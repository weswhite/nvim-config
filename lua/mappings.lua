...
map("n", "<leader>xd", "<cmd>Trouble diagnostics toggle document_diagnostics<cr>", { desc = "Document Diagnostics" })
...
-- ESLint mappings (add these to your mappings.lua)
map("n", "<leader>ef", "<cmd>EslintFixAll<CR>", { desc = "ESLint fix all" })
map("n", "<leader>er", "<cmd>LspRestart eslint<CR>", { desc = "Restart ESLint server" })
map("n", "<leader>tf", "<cmd>TSFix<CR>", { desc = "Fix TS + ESLint issues" })
